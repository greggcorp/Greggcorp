...
My strongest recommendation then—and now—is to put research where people are *already* working. Not in a purpose-built research tool that only the research team has (or wants) access to. Not in a deck that no one will ever see. Not in a custom dashboard in a workspace no one will ever stumple upon. What I said back then was if your org uses Google Workspace, store your work in Sheets, Docs, Slides, and Sites so folks might luck into finding it in their workspace search results. If your org uses Notion and Slack, use Notion and Slack to contain and communicate research.
